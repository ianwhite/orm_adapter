...
ORM Adapter will support only basic methods, as +get+, +find_first+, +create!+ and so forth. It is not ORM Adapter goal to support different query constructions, handle table joins, etc.
