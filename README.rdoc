...
== Example of use
  ...
  user_model.save(object)                 # saves the user object
...
We welcome you to write new adapters as gems. ORM Adapter will stay focused in having these major ORMs working. Other adapters will be named <tt>orm_adapter-somedatabase</tt>, you can find the ones available {on rubygems}[https://rubygems.org/search?query=orm_adapter-].
