...
== Example of use
  ...
  User # is it an ActiveRecord, DM Resource, Riak Ripple, MongoMapper or MongoId Document?
...
Currently supported ORMs are *ActiveRecord*, *DataMapper*, *Riak Ripple*, *MongoMapper*, and *MongoId*.
...
{Daniël W. Crompton}[http://github.com/webhat] contributes the Riak Ripple adapter.
